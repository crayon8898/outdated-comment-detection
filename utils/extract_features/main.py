...
model = Word2Vec.load("/Users/chenyn/chenyn's/研究生/DataSet/My/word2vector/wordvector/from_changes_word_vector.model")
...
def getFeatures(filepath):
    with open(filepath) as f:
        ...
        newfile = open(("/Users/chenyn/chenyn's/研究生/DataSet/My/features/features_10_23_drop_duplicates/") + os.path.split(filepath)[1],
                       'w')
...
blwjj("/Users/chenyn/chenyn's/研究生/DataSet/My/data/changes_drop_duplicates")
