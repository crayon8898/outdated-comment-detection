...
# rfc = naive_bayes.BernoulliNB()
# rfc = naive_bayes.ComplementNB()
# rfc = naive_bayes.GaussianNB()
# rfc = naive_bayes.MultinomialNB()
rfc = linear_model.LogisticRegression(max_iter=10000,multi_class='ovr')
